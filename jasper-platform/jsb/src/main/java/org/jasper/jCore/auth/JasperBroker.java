...
public class JasperBroker extends BrokerFilter {
    ...
    public void addConnection(ConnectionContext context, ConnectionInfo info) throws Exception {  
    	...
    	if(JECore.getInstance().isSystemDeploymentId(info.getUserName().split(":")[3])){
    		...
    		logger.error("jApp deploymentId does not match that of the system. jApp deploymentId : " + info.getUserName().split(":")[3] + " and system deploymentId : " + JECore.getInstance().getDeploymentID());
	    	throw (SecurityException)new SecurityException("jApp deploymentId does not match that of the system. jApp deploymentId : " + info.getUserName().split(":")[3] + " and system deploymentId : " + JECore.getInstance().getDeploymentID());
    	}
