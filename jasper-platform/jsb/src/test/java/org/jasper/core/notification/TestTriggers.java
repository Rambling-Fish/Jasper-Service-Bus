...
public class TestTriggers extends TestCase {
	...
	private static final String EXPIRY = "10";
	private static final String POLLING = "5";
	...
	/*
	 * This tests the utility class JsonResponseParser 
	 * request.
	 */
	@Test
	...
	public void testTriggerFactory() {
		...
		Trigger trig1 = factory.createTrigger(COMPARE_INT, RURI, "gt", "20");
		Trigger trig2 = factory.createTrigger(RANGE, RURI, "10", "25");
		Trigger trig3 = factory.createTrigger("wrong", RURI, "gt", "45");
		Trigger trig4 = factory.createTrigger(COMPARE_INT, RURI);
		...
		boolean result = trig1.evaluate(null);
	...
	public void testCompareIntTrigger() {
		...
		TriggerFactory factory = new TriggerFactory();
		Trigger gtCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "gt", "20");
		Trigger gtCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "gt", "25");
		Trigger eqCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "eq", "25");
		Trigger eqCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "eq", "5");
		Trigger ltCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "lt", "38");
		Trigger ltCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "lt", "25");
		Trigger neCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "ne", "26");
		Trigger neCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "ne", "25");
		Trigger geCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "ge", "22");
		Trigger geCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "ge", "27");
		Trigger leCompareInt  = factory.createTrigger(COMPARE_INT, RURI, "le", "25");
		Trigger leCompareInt2 = factory.createTrigger(COMPARE_INT, RURI, "le", "24");
		Trigger badCompareInt = factory.createTrigger(COMPARE_INT, RURI, "bad", "25");
		Trigger right         = factory.createTrigger(COMPARE_INT, RURI, "lt", "http://jasper.com");
	...
	public void testRangeTrigger() {
		...
		Trigger range2  = factory.createTrigger(RANGE, RURI, "26", "36");
		Trigger range3  = factory.createTrigger(RANGE, "30T", "25", "36");
