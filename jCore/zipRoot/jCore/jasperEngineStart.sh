...
java -ea -DjCore-engine-property-file=$JASPER_ENGINE_PROPERTY_FILE -DjCore-engine-log4j-xml=$JASPER_ENGINE_LOG4J_xml -classpath $JASPER_ENGINE_CLASSPATH $JASPER_ENGINE_MAIN_CLASS
