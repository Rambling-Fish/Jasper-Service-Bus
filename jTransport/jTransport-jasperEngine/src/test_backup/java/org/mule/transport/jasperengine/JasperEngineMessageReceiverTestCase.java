...
public class JasperEngineMessageReceiverTestCase extends AbstractMessageReceiverTestCase
{
    ...
    public MessageReceiver getMessageReceiver() throws Exception
    {
        ...
        return new JasperEngineMessageReceiver(endpoint.getConnector(), (Service) mockService.proxy(), endpoint);
    }
